...
const NEXT_STATUSES: Record<string, ApplicationStatus[]> = {
  ...
  applied_with_issues: ["screening", "rejected", "withdrawn"],
  manual_required: ["applied", "withdrawn"],
            ...
            <div className="flex flex-wrap gap-2">
              {application.status === "ready" && (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-lg bg-orange-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-orange-700 disabled:opacity-50 transition-colors"
                >
